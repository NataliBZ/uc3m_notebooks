  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 4, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 10);
 	...
 	gSKv3_1bar = _parm_default[0]; /* 1e-05 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 10);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 SKv3_1 /Users/natalibarroszulaica/Desktop/OBI/UC3M/UC3M_notebooks_tutorials_LOCAL/uc3m_notebooks/Cellular/04_Analysis_of_traces/SKv3_1.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/natalibarroszulaica/Desktop/OBI/UC3M/UC3M_notebooks_tutorials_LOCAL/uc3m_notebooks/Cellular/04_Analysis_of_traces/SKv3_1.mod";
